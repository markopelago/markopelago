...
class Vocabulary{
	...
	public function words($index){
		...
		$arr[$l]["email_confirmation_token_expired"]			= "This email confirmation link has expired, please contact csmarkopelago@gmail.com";
		$arr[$l]["email_confirmation_failed"]					= "Email confirmation failed, please contact csmarkopelago@gmail.com";
		$arr[$l]["email_confirmed"]								= "Thank You, Your email confirmation was success.";
		$arr[$l]["phone_confirmation_token_expired"]			= "This confirmation link has expired, please contact csmarkopelago@gmail.com";
		$arr[$l]["phone_confirmation_failed"]					= "Confirmation failed, please contact csmarkopelago@gmail.com";
		...
		$arr[$l]["amount_to_be_paid"]							= "Amount to be paid";
		$arr[$l]["unique_code"]									= "Unique Code";
		...
		$arr[$l]["no_shippingcharges_desc"]						= "The route is not available, please select<br>Shipping Courier or other courier service";
		...
		$arr[$l]["are_you_sure_pay_with_cod"]					= "Purchases will be canceled if the distance exceeds {cod_max_km} Km. Are you sure to pay in cash when the goods arrives?";
		...
		$arr[$l]["email_confirmation_token_expired"]			= "Link konfirmasi email ini telah kedaluwarsa, silakan hubungi csmarkopelago@gmail.com";
		$arr[$l]["email_confirmation_failed"]					= "Konfirmasi email gagal, silakan hubungi csmarkopelago@gmail.com";
		$arr[$l]["email_confirmed"]								= "Terima Kasih, Konfirmasi email Anda telah berhasil.";
		$arr[$l]["phone_confirmation_token_expired"]			= "Link konfirmasi ini telah kedaluwarsa, silakan hubungi csmarkopelago@gmail.com";
		$arr[$l]["phone_confirmation_failed"]					= "Konfirmasi gagal, silakan hubungi csmarkopelago@gmail.com";
		...
		$arr[$l]["amount_to_be_paid"]							= "Jumlah yang harus dibayar";
		$arr[$l]["unique_code"]									= "Kode Unik";
		...
		$arr[$l]["no_shippingcharges_desc"]						= "Rute tersebut tidak tersedia, Silakan pilih<br>Kurir Pengiriman atau Servis kurir yang lain";
		...
		$arr[$l]["are_you_sure_pay_with_cod"]					= "Pembelian akan di batalkan jika jarak antar melebihi {cod_max_km} Km. Anda yakin akan membayar dengan tunai pada saat barang sampai?";
