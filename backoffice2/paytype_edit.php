...
<div class="bo_title">Edit Payment Type</div>
<?php
	if(isset($_POST["save"])){
		$db->addtable("payment_types");$db->where("id",$_GET["id"]);
	...
	$db->addtable("payment_types");$db->where("id",$_GET["id"]);$db->limit(1);$pay = $db->fetch_data();
