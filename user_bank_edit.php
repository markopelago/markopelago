<?php
	...
	if(isset($_POST["save_bank"])){
		$db->addtable("user_banks");		$db->where("id",$_GET["id"]); $db->where("user_id",$__user_id);
	...
	$user_bank = $db->fetch_all_data("user_banks",[],"id='".$_GET["id"]."' AND user_id='".$__user_id."'")[0];
?>
<div class="row">	
	<div class="container">
		<h4 class="well"><b><?=strtoupper(v("edit_bank"));?></b></h4>
	</div>
	<div class="container">
		<form method="POST">
			<div class="col-md-12">
			...
			<div class="form-group">
				<label><?=v("account_name");?></label><?=$f->input("name",$user_bank["name"],"required placeholder='".v("account_name")."...'","form-control");?>
			</div>
			<div class="form-group">
